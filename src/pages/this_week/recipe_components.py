"""
Recipe display components for the This Week page
"""
...
def display_clear_button() -> bool:
    """Display and handle the clear all recipes button
    
    Returns:
        bool: True if clear button was clicked, False otherwise
    """
    st.divider()
